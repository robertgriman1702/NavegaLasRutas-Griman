const products = [
  {
    ...
    description: "Set completo de útiles escolares básicos para niños en etapa preescolar. Incluye todo lo necesario para comenzar el año escolar.",
    price: 15.00,
  ...
  },
  {
    id: 2,
    name: "Combo Básico",
    description: "Paquete esencial de útiles escolares para estudiantes de cualquier nivel. Ideal para el regreso a clases.",
    price: 20.00,
  ...
  {
    id: 3,
    name: "ALMOHADILLA PARA SELLO No. 2 AMIKO",
  ...
  {
    id: 4,
    name: "ALMOHADILLA HUELLERO No. 116 RD",
  ...
  {
    id: 5,
    name: "ARCHIVADORES LOMO ANCHO CARTA/OFICIO OFIMAK",
  ...
  {
    id: 6,
    name: "ARCHICOMODOS PLASTICOS OFFICE. BULTO 20 UNID.",
  ...
  {
    id: 7,
    name: "BOLIGRAFOS GEL NEGRO RD. 12 UNID.",
  ...
  {
    id: 8,
    name: "BOLIGRAFO SEMI GEL 12 unid. ESTOL Negro/Azul/Rojo",
